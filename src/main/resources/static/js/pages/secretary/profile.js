/* ================================================
   profile.js  –  Secretary profile logic
   ================================================ */
...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    try {
        const profileData = await AppointmentService.fetchData("/api/user/me"); // or fetch
        const fName = $("f-name");
    ...
    btnEdit?.addEventListener("click", async () => {
        if (editing) {
            ...
            try {
                // If AppointmentService is not strictly available, we can use fetch
